        ...
        <div class="container py-5 ">
            <div class="row justify-content-center">
                <div class="col-md-5 picture">
                    <img src="img/img2.jpg" id="mainpic" alt="">
            ...
            <div class="row seller rounded border border-secondary mt-md-5 mt-3">
                ...
                <div class="col-3 col-md-2 p-md-3 border-start border-secondary align-self-center text-center"><a href="profilMerchant">Kunjungi Toko</a></div>
            </div>
        </div>
    </section>
